...
const transferSchema = yup.object({
    accountNumber: yup.string().required("Account Number is required").test('len', 'Account Number should be exactly 10 digits', val => { if(val) return val.toString().length === 10}),
